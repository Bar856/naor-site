...
export default function Changes() {
  ...
  return (
    <div id="djs" className='aboutCont heightWidth black'>
      ...
      <img className='changesPics' src={pic1} alt="chnage1" />
      <img className='changesPics' src={pic2} alt="chnage1" />
      <img className='changesPics' src={pic3} alt="chnage1" />
      <img className='changesPics' src={pic4} alt="chnage1" />
      <img className='changesPics' src={pic5} alt="chnage1" />
      <img className='changesPics' src={pic6} alt="chnage1" />
      <img className='changesPics' src={pic7} alt="chnage1" />
      <img className='changesPics' src={pic8} alt="chnage1" />
      <img className='changesPics' src={pic9} alt="chnage1" />
    </div>
  )
}
